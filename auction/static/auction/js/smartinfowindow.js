...
SmartInfoWindow.prototype.draw = function() {
  ...
  this.div_.style.background = 'url("/static/auction/images/' + image + '")';
...
SmartInfoWindow.prototype.createElement = function() {
  ...
  if (!div) {
    ...
    closeImg.src = '/static/auction/images/closebigger.gif';
    ...
    // and rendering badly.
    document.getElementById("googft-mapCanvas").appendChild(div);
